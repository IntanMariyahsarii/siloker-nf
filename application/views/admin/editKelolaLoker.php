        ...
        <div class="row align-items-stretch no-gutters contact-wrap">
            <div class="col-md-12">
                <div class="form h-100">
                    <h3>Form Edit Loker</h3>
                    <form class="mb-5" action="<?= base_url("Dashboard/updateKelolaLoker") ?>" method="post">

                        <?php foreach ($loker as $loker) { ?>

                            <input type="text" name="lokerId" value="<?= $loker->id ?>" hidden>
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <select class="form-control" name="mitra">
                                        ...
                                        <?php foreach ($mitra as $mitra) { ?>
                                            <option value="<?= $mitra->id ?>" <?= $loker->mitra_id == $mitra->id ? "selected" : "" ?>><?= $mitra->nama ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <textarea class="form-control" name="deskripsi" id="message" placeholder="Deskripsi Lowongan"><?= $loker->deskripsi_pekerjaan ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanggal"  value="<?= $loker->tanggal_akhir ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="email" value="<?= $loker->email ?>">
                                </div>
                            </div>
